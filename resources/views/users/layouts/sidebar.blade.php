...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="" data-bs-toggle="dropdown">
            <img src="{{ asset('backend/assets/img/fotohariyanto.jpg') }}" alt="Profile" class="rounded-circle">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="d-flex flex-column align-items-center text-center">
          <img src="{{ asset('backend/assets/img/fotohariyanto.jpg') }}" alt="Profile" class="rounded-circle mb-1">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>ZhidarAugel</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
