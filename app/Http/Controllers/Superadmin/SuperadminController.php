...
class SuperadminController extends Controller
{
    ...
    public function klasifikasi(Request $request)
    {
        ...
        if ($request != "") {
            ...
            if(isset($hasil_normalisasi)){
                return view('superadmin.penilaian.klasifikasi', compact(['kriteria', 'eval_pegawai', 'tampil_normalisasi', 'perangkingan']));
            }else{
    ...
    public function hasil(Request $request)
    {
        ...
        return view('superadmin.penilaian.hasil', compact('eval_pegawai', 'kriteria', 'tampil_preferensi'));
    }
